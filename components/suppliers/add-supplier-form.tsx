...
export function AddSupplierForm({ onSuccess, onCancel }: AddSupplierFormProps) {
  ...
  const [isLegalEntity, setIsLegalEntity] = useState(true); // true = PJ, false = PF
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <input
          ...
          placeholder={isLegalEntity ? 'Ex: Distribuidora ABC' : 'Ex: João Silva'}
        />
      </div>
      ...
      <div className="flex gap-3 pt-4">
        ...
        >
          {isLoading ? 'Salvando...' : 'Criar Fornecedor'}
        </button>
        {onCancel && (
          <button
            type="button"
