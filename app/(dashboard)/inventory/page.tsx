...
export default function InventoryPage() {
  ...
  // Mostrar mensagem se não houver estabelecimento selecionado
      ...
      <div className="space-y-6">
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-yellow-800 mb-2">Nenhum estabelecimento selecionado</h3>
              <p className="text-yellow-700 mb-4">
                Para gerenciar o estoque, você precisa selecionar um estabelecimento. Clique no seletor de estabelecimento no menu superior.
              </p>
            </div>
          </div>
        </div>
